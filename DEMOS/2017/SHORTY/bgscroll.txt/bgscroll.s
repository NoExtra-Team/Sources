...
***************************************************************
Scrolling:
	move.l	physique(pc),a0          ; Physique screen selected for display the effect
	lea	160*93+8*13(a0),a0           ; And put the Scrolltext in the middle of the screen
	lea	Buffer_Scroll,a2         ; Buffer of the character font
...
restart:                             
	...
	tst.b	d0                       
	bne.s	.noendtxt                
	move.l	#stext,pt_text           ; Or restart the text
	bra.s	restart                  
.noendtxt:                           
...
.search:	                         
	...
	cmp.b	(a2)+,d0                 
	bne.s	.search                  
	lea		fonte,a0                 ; Find Font character to display
search0:                             
	cmpi	#20,d1                   
	bmi.s	.search1                 
	lea		640(a0),a0               
...
.search1:                            
	...
	lea	Buffer_Scroll,a2             ; Recopy Font character to the Buffer character
	moveq	#16-1,d0
.recopy:
	move	(a0),(a2)+
	lea		40(a0),a0
...
pt_text: ; The Text of the Scrolling
	dc.l	stext
stext:
	dc.b	"TEXT OF THE SCROLLING WITH ONE BITPLANE FONT IN 16 X 16 PIXELS. ENJOY ! "
	dc.b	"CECI EST UNE DEMONSTRATION POUR LE MAGAZINE PROGRAMMEZ..."
	dc.b	"                       "
	dc.b	0
	even
...
Buffer_Scroll: ; Scrolling Buffer
	ds.b	16*4
