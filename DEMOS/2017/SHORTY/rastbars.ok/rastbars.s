...
.put:MOVEQ     #0,D1 
      ...
      MOVEQ     #0,D6 
      MOVE.W    #$F,D7
.loop:LEA       mask_RB(PC),A1
      MOVEM.L   points_RB(PC),D0-D4 
      MOVE.W    (A1)+,D0
      MOVE.W    (A1)+,D1
      MOVE.W    (A1)+,D2
      MOVE.W    (A1)+,D3
...
.clear:
      MOVE.L    D0,(A0)+
      dbf	d1,.clear
      MOVE.W    swap1_RB(PC),swap2_RB 
      MOVE.W    #50-1,D7 ; lignes
.loop:LEA       buffer_gen_1_RB,A2
      LEA       buffer_gen_2_RB,A5
      MOVE.W    swap2_RB(PC),D0
      MOVE.L    0(A5,D0.W),D0 
      ADDI.W    #$28,swap2_RB
      MOVE.B    #$B,D1
      ASR.L     D1,D0 
...
MUSIC:
	incbin "I*.SND"            ; SNDH Music played at the VBL
	even
