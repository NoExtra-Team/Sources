...
*                                                             *
***************************************************************
HBLG: CLR.B     $FFFFFA1B.W 
      MOVE.L    #HBL_GOOD,$120.W 
      MOVE.B    #1,$FFFFFA21.W
      MOVE.B    #8,$FFFFFA1B.W
      rte

HBL_GOOD: MOVE.W    HBLG,$FFFF8240.W
...
.next:LEA       LIGNE,A0
      ADDA.W    COMPTEUR,A0
      LEA       BUFFER_COLOR,A2
      MOVE.L    #$019B019B,D0 ; imprime la couleur de fond
      MOVE.W    #8,D1 
.add: MOVE.L    D0,(A2)+
      MOVE.L    D0,(A2)+
      MOVE.L    D0,(A2)+
...
COULEUR:
		...
		dc.w	$043,$054,$065,$076,$065,$054,$043 * vert 1
