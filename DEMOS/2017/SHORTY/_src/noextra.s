...
**************************** MAIN LOOP ************************>
	...
	move.l	#Cadre_image+34,a0
	move.l	#160*200/4-1,d0
	move.l	(a0)+,(a1)+
	dbf	d0,*-2

	move.l	#NoExtra_image+34,a0                ; FROM ADRESS DATA
...
Default_palette:
	dc.w	$0114,$0416,$0316,$0516,$0016,$0216,$0616,$0116
	dc.w	$0716,$0114,$0717,$0000,$0000,$0000,$0000,$0777
