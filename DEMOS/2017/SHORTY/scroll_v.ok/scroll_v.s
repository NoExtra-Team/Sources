...
play_generated_code:
	    LEA       Buffer_Screen_V,A6
      ADDA.L    compteur_V(PC),A6
      ADDQ.L    #2,compteur_V
      CMPI.L    #$5C20,compteur_V
      BLT.S     .next 
      CLR.L     compteur_V 
.next:MOVEA.L   physique(PC),A5
      ADD.l    #160*73+8*7,A5 
      LEA       courbe_V(PC),A0
      ADDA.W    add_V(PC),A0
      ADDQ.W    #2,add_V
...
generate_code:
      ...
      MOVE.W    #8*5,D1 
      MOVEQ     #9-4,D7 
lp_gV:MOVE.W    pos_V03(PC),(A0)+ 
      MOVE.W    pos_V04(PC),(A0)+ 
      MOVE.W    pos_V05(PC),(A0)+ 
      MOVE.L    pos_V02(PC),D3
      MOVE.W    D0,D3 
      MOVE.L    pos_V01(PC),D4
      MOVE.W    D1,D4 
      MOVE.W    #54-1,D6 
.loop:MOVE.L    D4,(A0)+
      MOVE.L    D3,(A0)+
